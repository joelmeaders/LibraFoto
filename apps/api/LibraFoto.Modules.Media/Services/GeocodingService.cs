...
namespace LibraFoto.Modules.Media.Services
{
    ...
    public class GeocodingService : IGeocodingService
    {
        ...
        private static readonly TimeSpan _rateLimit = TimeSpan.FromSeconds(1);
        ...
        public bool IsRateLimited
        {
            get
            {
                ...
                return timeSinceLastRequest < _rateLimit || _requestsThisMinute >= MaxRequestsPerMinute;
            }
        }
        ...
        private async Task WaitForRateLimitAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                {
                    await Task.Delay(_rateLimit - timeSinceLastRequest, cancellationToken);
                }
            }
            finally
            {
