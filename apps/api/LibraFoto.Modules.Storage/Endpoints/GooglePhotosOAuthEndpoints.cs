...
{
    private static readonly string[] GooglePhotosScopes =
    [
        ...
        CancellationToken cancellationToken)
    {
        ...
        authUrl.Scope = string.Join(" ", GooglePhotosScopes);
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var missingScopes = GooglePhotosScopes
            ...
            if (missingScopes.Count > 0)
            {
                logger.LogError(
                    ...
                    string.Join(", ", GooglePhotosScopes),
                    string.Join(", ", grantedScopes),
