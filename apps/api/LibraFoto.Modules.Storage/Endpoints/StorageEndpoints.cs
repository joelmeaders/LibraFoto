...
public static class StorageEndpoints
{
    ...
    private static readonly string[] GooglePhotosRequiredScopes =
    [
    ...
    private static string? GetProviderStatusMessage(Data.Entities.StorageProvider entity)
    {
        ...
        try
        {
            ...
            {
                var missingScopes = GooglePhotosRequiredScopes
    ...
    private static bool HasRequiredScopes(IEnumerable<string> grantedScopes)
    {
        ...
        return GooglePhotosRequiredScopes.All(scopeSet.Contains);
    }
