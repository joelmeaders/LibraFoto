...
using LibraFoto.Modules.Admin.Features.Albums;
...
public class AlbumEndpointsTests
{
    ...
    {
        // Act
        var result = await GetAlbumsEndpoint.HandleRequestAsync(_albumService, CancellationToken.None);
    ...
    public async Task GetAlbumById_WithExistingAlbum_ReturnsAlbum()
    {
        ...
        // Act
        var result = await GetAlbumByIdEndpoint.HandleRequestAsync(1L, _albumService, CancellationToken.None);
    ...
    {
        // Act
        var result = await GetAlbumByIdEndpoint.HandleRequestAsync(999L, _albumService, CancellationToken.None);
    ...
    public async Task CreateAlbum_WithValidData_CreatesAlbum()
    {
        ...
        // Act
        var result = await CreateAlbumEndpoint.HandleRequestAsync(request, _albumService, CancellationToken.None);
    ...
    public async Task UpdateAlbum_WithValidData_UpdatesAlbum()
    {
        ...
        // Act
        var result = await UpdateAlbumEndpoint.HandleRequestAsync(1L, request, _albumService, CancellationToken.None);
    ...
    public async Task UpdateAlbum_WithNonExistentAlbum_ReturnsNotFound()
    {
        ...
        // Act
        var result = await UpdateAlbumEndpoint.HandleRequestAsync(999L, request, _albumService, CancellationToken.None);
    ...
    public async Task DeleteAlbum_WithExistingAlbum_DeletesAlbum()
    {
        ...
        // Act
        var result = await DeleteAlbumEndpoint.HandleRequestAsync(1L, _albumService, CancellationToken.None);
    ...
    {
        // Act
        var result = await DeleteAlbumEndpoint.HandleRequestAsync(999L, _albumService, CancellationToken.None);
    ...
    public async Task SetCoverPhoto_WithValidData_SetsCoverPhoto()
    {
        ...
        // Act
        var result = await SetAlbumCoverPhotoEndpoint.HandleRequestAsync(1L, 1L, _albumService, CancellationToken.None);
    ...
    {
        // Act
        var result = await SetAlbumCoverPhotoEndpoint.HandleRequestAsync(999L, 1L, _albumService, CancellationToken.None);
    ...
    public async Task RemoveCoverPhoto_WithValidData_RemovesCoverPhoto()
    {
        ...
        // Act
        var result = await RemoveAlbumCoverPhotoEndpoint.HandleRequestAsync(1L, _albumService, CancellationToken.None);
    ...
    public async Task AddPhotosToAlbum_WithValidData_AddsPhotos()
    {
        ...
        // Act
        var result = await AddPhotosToAlbumEndpoint.HandleRequestAsync(1L, request, _albumService, CancellationToken.None);
    ...
    public async Task RemovePhotosFromAlbum_WithValidData_RemovesPhotos()
    {
        ...
        // Act
        var result = await RemovePhotosFromAlbumEndpoint.HandleRequestAsync(1L, request, _albumService, CancellationToken.None);
    ...
    public async Task ReorderPhotos_WithValidData_ReordersPhotos()
    {
        ...
        // Act
        var result = await ReorderPhotosInAlbumEndpoint.HandleRequestAsync(1L, request, _albumService, CancellationToken.None);
    ...
    public async Task ReorderPhotos_WithNonExistentAlbum_ReturnsNotFound()
    {
        ...
        // Act
        var result = await ReorderPhotosInAlbumEndpoint.HandleRequestAsync(999L, request, _albumService, CancellationToken.None);
