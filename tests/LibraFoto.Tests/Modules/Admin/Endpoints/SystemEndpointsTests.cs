using LibraFoto.Modules.Admin.Features.System;
...
public class SystemEndpointsTests
{
    ...
    public async Task GetSystemInfo_ReturnsSystemInfo()
    {
        ...
        // Act
        var result = await GetSystemInfoEndpoint.HandleRequestAsync(_systemService, CancellationToken.None);
    ...
    public async Task CheckForUpdates_ReturnsUpdateCheckResponse()
    {
        ...
        // Act
        var result = await CheckForUpdatesEndpoint.HandleRequestAsync(_systemService, CancellationToken.None);
    ...
    public async Task ForceCheckForUpdates_ForcesRefresh()
    {
        ...
        // Act
        var result = await ForceCheckForUpdatesEndpoint.HandleRequestAsync(_systemService, CancellationToken.None);
    ...
    public async Task TriggerUpdate_ReturnsAcceptedResponse()
    {
        ...
        // Act
        var result = await TriggerUpdateEndpoint.HandleRequestAsync(_systemService, CancellationToken.None);
