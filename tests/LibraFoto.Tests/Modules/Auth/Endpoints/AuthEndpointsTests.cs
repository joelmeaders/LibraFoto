...
using LibraFoto.Modules.Auth.Features.Authentication;
...
public class AuthEndpointsTests
{
    ...
    public async Task Login_WithValidCredentials_ReturnsOkWithTokens()
    {
        ...
        // Act
        var result = await LoginEndpoint.HandleRequestAsync(request, _authService, CancellationToken.None);
    ...
    public async Task Logout_WithValidUser_ReturnsOk()
    {
        ...
        // Act
        var result = await LogoutEndpoint.HandleRequestAsync(user, _authService, CancellationToken.None);
    ...
    public async Task GetCurrentUser_WithValidUser_ReturnsOkWithUserDto()
    {
        ...
        // Act
        var result = await GetCurrentUserEndpoint.HandleRequestAsync(user, _authService, CancellationToken.None);
    ...
    public async Task RefreshToken_WithValidToken_ReturnsOkWithNewTokens()
    {
        ...
        // Act
        var result = await RefreshTokenEndpoint.HandleRequestAsync(request, _authService, CancellationToken.None);
    ...
    public async Task ValidateToken_WithValidToken_ReturnsOkWithUserId()
    {
        ...
        // Act
        var result = await ValidateTokenEndpoint.HandleRequestAsync(authorization, _authService, CancellationToken.None);
