using LibraFoto.Modules.Display.Features.Config;
...
public class DisplayConfigEndpointsTests
{
    ...
    public async Task GetDisplayConfig_UsesMachineLanIp_WhenRelativePathConfigured()
    {
        ...
        // Act
        var result = GetDisplayConfigEndpoint.GetDisplayConfig(configuration, httpContext, machineLanIp);
    ...
    {
        // Act
        var result = GetDisplayConfigEndpoint.GetMachineLanIp();
