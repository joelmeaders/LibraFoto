...
using LibraFoto.Modules.Display.Features.Settings;
...
internal static class DisplaySettingsEndpoints_TestHelper
{
    ...
    {
        return await GetActiveDisplaySettingsEndpoint.HandleRequestAsync(settingsService, CancellationToken.None);
    }

    public static async Task<Ok<IReadOnlyList<DisplaySettingsDto>>> GetAllSettings(
        IDisplaySettingsService settingsService)
    {
        return await GetAllDisplaySettingsEndpoint.HandleRequestAsync(settingsService, CancellationToken.None);
    }
    ...
    {
        return await GetDisplaySettingsByIdEndpoint.HandleRequestAsync(id, settingsService, CancellationToken.None);
    }
    ...
    {
        return await UpdateDisplaySettingsEndpoint.HandleRequestAsync(
            id,
            request,
            settingsService,
            slideshowService,
    ...
    public static async Task<Results<Created<DisplaySettingsDto>, BadRequest<ApiError>>> CreateSettings(
        ...
        IDisplaySettingsService settingsService)
    {
        return await CreateDisplaySettingsEndpoint.HandleRequestAsync(request, settingsService, CancellationToken.None);
    }

    public static async Task<Results<NoContent, NotFound<ApiError>, BadRequest<ApiError>>> DeleteSettings(
        long id, IDisplaySettingsService settingsService)
    {
        return await DeleteDisplaySettingsEndpoint.HandleRequestAsync(id, settingsService, CancellationToken.None);
    }
    ...
    public static async Task<Results<Ok<DisplaySettingsDto>, NotFound<ApiError>>> ActivateSettings(
        ...
        ISlideshowService slideshowService)
    {
        return await ActivateDisplaySettingsEndpoint.HandleRequestAsync(
            id,
            settingsService,
            slideshowService,
            CancellationToken.None);
