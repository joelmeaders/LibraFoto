using LibraFoto.Modules.Media.Features.Metadata;
...
internal static class MetadataEndpoints_TestHelper
{
    ...
    {
        return await ExtractMetadataEndpoint.HandleRequestAsync(file, metadataService, geocodingService, CancellationToken.None);
    }
